...
public abstract class Fighter : MonoBehaviour
{
    ...
    protected void AutoConfigureSkillTargeting(Skill skill)
    {
        ...
        if (enemiesPanel.gameObject.activeSelf)
        {
    ...
    protected void Die()
    {
        SoundManager.instance.playSound(dieSound, 0.6f);
    ...
    {
        if (statusCondition != null && statusCondition.hasExpired)
        {
            Destroy(statusCondition.gameObject);
